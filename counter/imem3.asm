add $r2, $imm, $zero, 3       # $r2 = 0. $r2 shall hold the $required $remainder if we wish to increase the counter
...
a: lw $r5, $zero, $zero, 0     # $r5 = mem[0]. $r5 holds the value in counter
...
bne $imm, $r6, $r2, a       # if $remainder == $required $remainder increase value. We jump to instruction 4 because of delay slot
...
add $zero, $zero, $zero, 0       # no operation
add $r7, $zero, $imm, 1       # $r7 = 1
sll $r7, $r7, $imm, 8       # $r7 = $r7 * 2^8 = 2^8 = 256
lw $r8, $r7, $zero, 0        # cause a conflict miss and write to main memory the value of counter.
