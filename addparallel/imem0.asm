...
add $r3, $imm, $imm, 0      # $r3 = 0. $r3 shall hold the block offset in memory we calculate the sum for.
add $r11, $r2, $imm, 0      # $r11 = 1024. $r3 shall hold the end index for sum calculation.
a:
