...
sla $imm0, $r2, $imm, 12     # $imm0 = 4096. The offset of the second array
sla $r2, $r2, $imm, 10      # $r2 = 1024. The offset to finish copy in.
add $r3, $zero, $imm, 1024    # $r3 = 1024. $r3 shall hold the block offset in memory we calculate the sum for.
