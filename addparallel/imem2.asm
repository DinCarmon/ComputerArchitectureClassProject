...
sll $r3, $r2, $imm, 1       # $r3 = 2048. $r3 shall hold the block offset in memory we calculate the sum for.
add $r11, $r2, $r3, 0       # $r11 = 3072. $r3 shall hold the end index for sum calculation.
a:
