...
sll $r3, $r2, $imm, 1       
add $r3, $r3, $r2, 0        # $r3 = 3072. $r3 shall hold the block offset in memory we calculate the sum for.
sll $r11, $r2, $imm, 2      # $r11 = 4096. $r3 shall hold the end index for sum calculation.
a:
